...
cdef class G2:
    ...
    def get_g2(self):
        ...
        return g2, self.gradient_x, self.gradient_y, self.gradient_asymmetric_x, self.gradient_asymmetric_y, self.modules_normalized, self.phases, self.valid_pixels_count, self.assimetric_pixel_count, confluence